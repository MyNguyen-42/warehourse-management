...
// FJson returns an object zap.Field as json
func FJson(key string, obj interface{}) zap.Field {
	marshal, _ := json.Marshal(obj)
	return zap.String(key, string(marshal))
}

// FOrderCode returns an order_code zap.Field as json
func FOrderCode(orderCode string) zap.Field {
	return zap.String("order_code", orderCode)
}

// FTripCode returns an trip_code zap.Field as json
func FTripCode(tripCode string) zap.Field {
	return zap.String("trip_code", tripCode)
}

// FActionInput returns an action_input zap.Field as json
func FActionInput(actionInput string) zap.Field {
	return zap.String("action_input", actionInput)
}

// FActionRequestId returns an action_input zap.Field as json
func FActionRequestId(actionInputId string) zap.Field {
	return zap.String("action_input_id", actionInputId)
}

// FActionSource returns an action_source zap.Field as json
func FActionSource(actionSource string) zap.Field {
	return zap.String("action_source", actionSource)
}

// FHubId returns an hub_id zap.Field as json
func FHubId(hubId string) zap.Field {
	return zap.String("hub_id", hubId)
}
